...
> **Ask Claude anything about Amsterdam** - from finding your neighbor's property details to tracking city sustainability initiatives.
...
This tool lets you **ask Claude Desktop questions about Amsterdam** using real city data. No need to visit multiple websites or understand APIs - just ask in plain English!

**Example conversations you can have:**

💬 *"What's the address of the building at Dam Square 1?"*  
💬 *"Show me all gas-free neighborhoods in Amsterdam"*  
💬 *"How much gas does postal code 1012 consume?"*  
💬 *"Find me all Tesla cars registered in the Netherlands"*  
💬 *"Are there any public complaints about waste in Centrum?"*

**It works with Claude Desktop** using the Model Context Protocol (MCP) - think of it as giving Claude a direct line to Amsterdam's city databases.
...
### What You Get:
✅ **9 Amsterdam city databases** at your fingertips  
✅ **Natural language queries** - no coding required  
✅ **Real-time city data** - buildings, energy, sustainability, infrastructure  
✅ **Cross-data insights** - combine multiple sources in one question  
✅ **Free to use** - all data sources are open and free

### Perfect For:
- 🏠 **Real estate research** - property details, ownership, energy ratings
- 🌱 **Sustainability projects** - track gas-free zones and energy consumption
- 🏙️ **Urban planning** - infrastructure, neighborhoods, public reports
- 📊 **Data journalism** - combine city statistics for stories
- 🚗 **Vehicle research** - nationwide Dutch vehicle registry
...
1. Visit **[api.data.amsterdam.nl](https://api.data.amsterdam.nl)**
2. Click "Register" and create a free account
3. Go to "API Keys" and generate a new key
4. Copy your key - you'll need it in Step 3

> 💡 **No key?** Some features work without it, but you'll hit rate limits quickly.
